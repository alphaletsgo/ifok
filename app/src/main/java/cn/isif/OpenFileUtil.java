...
public class OpenFileUtil {
    //http://weibo.com/2803301701/FehEJBhdO?type=comment#_rnd1501320287313
...
//    public static String[][] getMIME_MapTable() {
...
//    }
    ...
    public static void openFile(Context context, File file) {
        ...
        try {
            ...
            e.printStackTrace();
            ToastUtils.showShort("无法打开此类型文件");
        }
    }
}